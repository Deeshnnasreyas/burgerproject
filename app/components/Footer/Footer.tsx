      ...
      <div className="w-[80%] pb-[2rem] border-b-[2px] border-b-gray-300 border-opacity-50 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[3rem] items-center">
        ...
        <div>
          ...
          <p className="text-white text-opacity-60 mt-[0.4rem]">
            ...
            rerum nemo rem sed vero, quisquam laborum, unde maiores nisi
            debitis, id sint? Nostrum delectus accusantium necessitatibus
            expedita, tempora quasi.
          </p>
          <p className="text-red-300 text-[19px] font-bold">+(123) 4567 8956</p>
        </div>
        {/* 2nd part */}
        <div>
          ...
          <p className="mt-[0.7rem] text-white opacity-55 hover:text-yellow-300 transition-all duration-100 cursor-pointer w-fit">
            Chiken Burger
          </p>
          <p className="mt-[0.7rem] text-white opacity-55 hover:text-yellow-300 transition-all duration-100 cursor-pointer w-fit">
            Beef Burger
        ...
        <div>
          ...
          <p className="text-white text-[18px]">
            Saturday :<span className="text-yellow-300">8am - 12M</span>
          </p>
          {/* special icons */}
